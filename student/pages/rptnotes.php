...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT n.*, s.name as subjectname, f.name as staffname 
                                        ...
                                        inner join staff f on n.staffid = f.id WHERE 
                                        n.status = 1 AND n.class = '$class' AND n.staffid IN (SELECT id FROM staff WHERE deptid = '$deptid')");
...
<head>
    ...
    <title><?= $project ?> : Notes Download</title>
