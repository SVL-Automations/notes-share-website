...
if (isset($_POST['submit'])) {
  ...
  $res = mysqli_query($connection, "select * from student where mobile = '$mobile' and email = '$username' and status='1'");
  if (mysqli_num_rows($res) == 1) {
    ...
    if ($mailstatus == 'Success') {
      $data = mysqli_query($connection, "update student set password = '$encpassword' where email = '$username'");
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      ...
      ?>
      <p class="login-box-msg">Student Forget Password </p>
