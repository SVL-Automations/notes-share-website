...
if (isset($_POST['changepassword'])) {
  ...
  if ($password == $repassword) {
    ...
    $username = $_SESSION['VALID_ACADEMY_STUDENT'];
    $result = mysqli_query($connection, "SET NAMES utf8mb4");
    $passwordupdate = mysqli_query($connection, "update `student` set `password`='$encpassword' where email='$username'");
...
<head>
  ...
  <title><?= $project ?> : Student Change Password</title>
